...
namespace EBSM.Repo
{
    public class DamageStockRepository
    {
        private WmsDbContext db;
        public DamageStockRepository(WmsDbContext context)
        {
            db = context;
        }
        public void Add(DamageStock item)
        {
            db.DamageStocks.Add(item);
        }
        public void Edit(DamageStock item)
        {
            db.Entry(item).State = EntityState.Modified;
        }
        public DamageStock GetById(int id)
        {
            return db.DamageStocks.Find(id); 
        }
        public DamageStock GetByStockId(int stockId)
        {
            return db.DamageStocks.FirstOrDefault(x=>x.StockId== stockId);
        }
        public IEnumerable<DamageStock> GetAll()
        {
            return db.DamageStocks;
        }
